 ...
 * `DAWN_DOUBLE_PRECISION` is defined. Note that it is strongly adviced to use
 * this typedef instead of `double` or `float` directly as the latter may incur
 * unnecessary casts in CUDA code.
 *
 * @ingroup dawn
 */
